...
import com.example.dto.UserDefinedUserProductsDto;
...
public interface GenericUserProductRepo extends JpaRepository<UserProducts,Integer>{
	...
	public int getProductCartQuantity(@Param("cartId")int cartId);
	...
	@Query(value = "select id as Id , price as Price, payment_table.payment_date as PaymentDate, "
			...
			+ "brand as Brand, category as Category, user_products.quantity as Quantity, user_products.metal as Metal, "
