...
public interface GenericUserRepository extends JpaRepository<User, Integer>{
	...
	@Modifying
	@Query(value="update user_table set password= :cid where email = :pid ", nativeQuery=true)
	public void ChangePassFromEmail(@Param("pid") String emailId, @Param("cid") String pass);
}
